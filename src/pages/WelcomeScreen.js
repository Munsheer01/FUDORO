...
function WelcomeScreen() {
  ...
  return (
    <div className={styles.wrapper}>
      ...
      {/* Accordion Sections */}
      <main className={styles.accordionMain}>
        <AccordionSection title="Services We Offer" id="servicesAccordion">
        ...
        <AccordionSection title="How We Work" id="howAccordion">
        ...
        <AccordionSection title="Events We Cater" id="eventsAccordion">
        ...
        <AccordionSection title="Hear from Our Customers" id="testimonialsAccordion">
        ...
        <AccordionSection title="Contact Us" id="contactAccordion">
